...
export const ProductTile: FC<ProductTileProps> = ({ product }) => {
  return (
    <button
      className="w-72 p-3 rounded-lg flex flex-col border-2 border-[#C7C7CC] cursor-pointer items-start shrink-0 snap-start space-y-1"
      type="button"
    >
      ...
      <span className="text-lg font-bold line-clamp-1 text-left h-7 w-64">
        {product.name}
      </span>
